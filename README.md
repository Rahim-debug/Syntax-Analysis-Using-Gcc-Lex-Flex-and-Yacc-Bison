# Syntax-analyzer
syntax analyzer using Yacc/bison for a java like language which has only methods(analogous to functions) and classes with lexical analyzer too with flex.

1) Change the directory to where lex file and parser file are
present on terminal
...
We have used lex for generating lex.yy.c and Yacc/
